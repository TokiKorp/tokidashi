...
export const TRANSLATIONS = {
  fr: {
    ...
    acct_section: "Compte",
    acct_pseudo: "Pseudo",
    acct_password: "Mot de passe",
    acct_register: "Créer un compte",
    acct_login: "Se connecter",
    acct_logout: "Se déconnecter",
    acct_logged_in_as: "Connecté en tant que",
    acct_switch_to_login: "Déjà un compte ? Se connecter",
    acct_switch_to_register: "Pas de compte ? En créer un",
    acct_advanced_options: "Options avancées",
  ...
  en: {
    ...
    acct_section: "Account",
    acct_pseudo: "Username",
    acct_password: "Password",
    acct_register: "Create account",
    acct_login: "Log in",
    acct_logout: "Log out",
    acct_logged_in_as: "Logged in as",
    acct_switch_to_login: "Already have an account? Log in",
    acct_switch_to_register: "No account? Create one",
    acct_advanced_options: "Advanced options",
